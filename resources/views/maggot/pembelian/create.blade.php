...
@section('title', 'Tambah Pembelian Maggot')

@section('content')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Pembelian Maggot</h1>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('maggot.pembelian.store') }}" method="POST">
                                    @csrf
                                    
                                    <div class="form-group row">
                                        <label for="no" class="col-sm-3 col-form-label">No Pembelian <span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('no') is-invalid @enderror" 
                                                   id="no" name="no" value="{{ old('no') }}" 
                                                   placeholder="Masukkan nomor pembelian" required>
                                            @error('no')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Masukkan keterangan pembelian" required>{{ old('keterangan') }}</textarea>
                                            @error('keterangan')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
